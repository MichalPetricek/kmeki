...
import { IconCheck, IconArrowRight, IconTram, IconElectric, IconGear, IconRacing, IconFlag } from '@/ui/Icons';
import { Link } from '@/i18n/navigation';

const galleryImages = [
  { src: '/images/parsVnitrni_oblozeni1.jpg', alt: 'Vnitřní obložení vagónu' },
  { src: '/images/parsVnitrni_oblozeni2.jpg', alt: 'Interiérové díly vagónu' },
  { src: '/images/t15_34.jpg', alt: 'Tramvaj T15 - exteriérové díly' },
  { src: '/images/t15_43.jpg', alt: 'Tramvaj T15 - detail' },
];

const productIcons = [IconTram, IconElectric, IconGear, IconRacing, IconFlag];
...
export default function IndustryPageClient() {
  ...
  const products = [
    ...
    { name: t('product5'), desc: t('product5Desc') },
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <ScrollAnimation variant="fadeIn">
              <div className="relative aspect-[4/3] rounded-2xl overflow-hidden border border-primary/10">
                <Image
                  src="/images/Skoda_15T_ForCity.jpg"
                  alt="Škoda 15T ForCity"
                  fill
        ...
        <div className="container-custom relative">
          ...
          <StaggerContainer className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
            {products.map((product, i) => {
              const Icon = productIcons[i] || IconGear;
              return (
                <StaggerItem key={i}>
