...
import { IconCheck, IconPillar, IconBrick, IconBuilding, IconPalette, IconArrowRight } from '@/ui/Icons';
import { Link } from '@/i18n/navigation';

const galleryImages = [
  { src: '/images/galerieViden[1].jpg', alt: 'Galerie Vídeň - architektonické prvky' },
  { src: '/images/Galerie křeslo.jpg', alt: 'Designové křeslo z kompozitu' },
];

const productIcons = [IconPillar, IconBrick, IconBuilding, IconPalette];
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <ScrollAnimation variant="fadeIn">
              <div className="relative aspect-[4/3] rounded-2xl overflow-hidden border border-primary/10">
                <Image
                  src="/images/galerieViden[1].jpg"
                  alt="Galerie Vídeň - architektonické prvky z kompozitu"
                  fill
        ...
        <div className="container-custom relative">
          ...
          <StaggerContainer className="grid md:grid-cols-2 gap-4">
            {products.map((product, i) => {
              const Icon = productIcons[i] || IconBuilding;
              return (
                <StaggerItem key={i}>
